...
// Do not display a post if it is not there
	...
	if($options['summarize']) {
		...
		$categoryIcon = ukIcon($options['categoryIcon'], ['class' => 'uk-light']);
		$body = explode('</p>', $body);
		$body = reset($body) . ' ';
		$body = str_replace('<p>', "<p class='uk-light uk-text-muted'>", $body);
...
<article class='uk-margin-small-bottom $class $bg_class' $style $dat_img>
		...
		<div class='$overlay_class'>
			...
			<p class='uk-margin-small'>
				<span class='uk-article-meta uk-inline $uk_class'>
					$metaIcon
					$byline
				</span>
