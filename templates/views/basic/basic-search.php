...
<div id='content-body'>
    ...
    if (count($matches)) {
				...
				echo "<h3 class='uk-text-center uk-h1 uk-text-success'>" . sprintf( setting('found-pages'), count($matches) ) . "</h3>";
        ...
        echo '</ul>';
				    ...
				    // we didn't find any
				    echo "<h3 class='uk-text-center uk-h1 uk-text-danger'>" . setting('no-found') . "</h3>";
				}
    ?>
</div><!-- /#content-body -->
